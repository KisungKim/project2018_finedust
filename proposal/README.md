...
>
> 이전에 학회에서 실시했던 공모전 내용들과 소프트웨어공학개론의 수업에서 배우고 활용했던 내용들을([링크참고](https://github.com/jwkim1104/SWE3002-01-Team1)) 복습하고 topcit 홈페이지의 에센스를 활용하여 본 제안서를 만들어습니다. 

<br/>

## Project Goal

> ### 1. 웹앱을 기획하고 배포하는 것을 목표로 한다
> ### 2. Business Goal의 경우 배포 후, 비회원의 재방문률을 기준으로 한다 
...
>
> 야외활동과 산책이 결합 가능한 키워드라고 가정, 본인의 생활 반경의 대기환경지수를 쉽게 알 수 있고 추가적인 컨텐츠로 야외활동과 관련한 > 서울의 산책/공원에 대한 추천정보를 노출시키는 것을 목표로 하였다.
